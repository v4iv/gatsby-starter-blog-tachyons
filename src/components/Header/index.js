...
const Header = () => (
  <header className='bg-white black-80 tc pv4 avenir'>
    <h1 className='mt2 mb0 baskerville i fw1 f1'>The Leaky Cauldron Blog</h1>
    ...
    <nav className='bt bb tc mw8 center mt4'>
      ...
      <Link className='f6 f5-l link bg-animate black-80 hover-bg-light-pink dib pa3 ph4-l' to='/about'>Search</Link>
